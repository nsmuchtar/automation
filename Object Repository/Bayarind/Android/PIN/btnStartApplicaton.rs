...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'START APPLICATION' or . = 'START APPLICATION') and @resource-id = 'net.sprintasia.ewallet:id/vBtnNext']</locator>
