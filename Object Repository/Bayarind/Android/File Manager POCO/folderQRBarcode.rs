...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'QR BARCODE' or . = 'QR BARCODE') and @resource-id = 'android:id/title']</locator>
