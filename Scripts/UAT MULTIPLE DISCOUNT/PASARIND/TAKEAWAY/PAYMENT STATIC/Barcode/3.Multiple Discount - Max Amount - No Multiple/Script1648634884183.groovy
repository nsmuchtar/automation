...
int balancePreTransaction = Mobile.getText(findTestObject('Object Repository/Pasarind Existing/Smallscreen/Withdrawal/saldoMerchant'), 
    0).replaceAll('[^0-9]', '').toInteger()
...
CustomKeywords.'pasarind_smallscreen.product.multipleDiscountMaxAmount'()
...
int payment = Mobile.getText(findTestObject('Object Repository/Pasarind Existing/Smallscreen/Payment Success/totalPayment'), 
    0).replaceAll('[^0-9]', '').toInteger()
...
int balancePostTransaction = Mobile.getText(findTestObject('Object Repository/Pasarind Existing/Smallscreen/Withdrawal/saldoMerchant'), 
    0).replaceAll('[^0-9]', '').toInteger()
