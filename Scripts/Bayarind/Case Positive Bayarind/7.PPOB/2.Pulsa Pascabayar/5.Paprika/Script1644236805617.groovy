...
tring kasAwalBayarind = Mobile.getText(findTestObject('Object Repository/Bayarind/Android/Homepage/saldoKasBayarind'), 0).replace('.', '')

int intKasAwalBayarind = Integer.parseInt(kasAwalBayarind)

CustomKeywords.'bayarind.ppob.ppobPulsaPascaBayar'()
