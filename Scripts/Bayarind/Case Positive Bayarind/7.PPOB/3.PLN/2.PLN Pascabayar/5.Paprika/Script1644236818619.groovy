...
CustomKeywords.'bayarind.ppob.ppobPLNPascabayar'()

CustomKeywords.'bayarind.ppob.transaksiPLNPascaBayar'()

String amount = Mobile.getText(findTestObject('Object Repository/Bayarind/Android/PPOB/PLN Pascabayar/amountPelanggan'), 0).replace('Rp', '').replace('.', '')
String transactionFee = Mobile.getText(findTestObject('Object Repository/Bayarind/Android/PPOB/PLN Pascabayar/transactionFeePelanggan'), 0).replace('Rp', '').replace('.', '')
String actualTotalBill = Mobile.getText(findTestObject('Object Repository/Bayarind/Android/PPOB/PLN Pascabayar/totalBillPelanggan'), 0).replace('Rp', '').replace('.', '')
...
Mobile.tap(findTestObject('Object Repository/Bayarind/Android/PPOB/PLN Pascabayar/btnNext'), 0)
