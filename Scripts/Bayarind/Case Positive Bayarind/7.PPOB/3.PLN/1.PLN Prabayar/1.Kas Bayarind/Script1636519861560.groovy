...
CustomKeywords.'bayarind.ppob.ppobPLNPrabayar'()

CustomKeywords.'bayarind.ppob.transaksiPLNPrabayar'()

String amount = Mobile.getText(findTestObject('Object Repository/Bayarind/Android/PPOB/PLN Prabayar/amountPelanggan'), 0).replace('Rp', '').replace('.', '')
String transactionFee = Mobile.getText(findTestObject('Object Repository/Bayarind/Android/PPOB/PLN Prabayar/transactionFeePelanggan'), 0).replace('Rp', '').replace('.', '')

Mobile.delay(1)
CustomKeywords.'general.control.swipeDownDetail'()


String actualTotalBill = Mobile.getText(findTestObject('Object Repository/Bayarind/Android/PPOB/PLN Prabayar/totalBillPelanggan'), 0).replace('Rp', '').replace('.', '')
...
Mobile.tap(findTestObject('Object Repository/Bayarind/Android/PPOB/PLN Prabayar/btnNext'), 0)
