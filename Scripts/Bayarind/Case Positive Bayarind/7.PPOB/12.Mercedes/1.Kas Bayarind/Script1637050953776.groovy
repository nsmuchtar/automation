...
String amount = Mobile.getText(findTestObject('Object Repository/Bayarind/Android/Membership/Mercedes/amountPelanggan'), 0).replace('.', '')
...
String totalPayment = Mobile.getText(findTestObject('Object Repository/Bayarind/Android/Payment Method/totalPaymentMembership'), 0).replace('Rp', '').replace('.', '')
