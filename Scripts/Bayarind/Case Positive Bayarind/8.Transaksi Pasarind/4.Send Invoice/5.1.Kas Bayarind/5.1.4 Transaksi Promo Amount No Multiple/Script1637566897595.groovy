...
CustomKeywords.'pasarind_smallscreen.product.productGurameBakar'()
...
CustomKeywords.'pasarind_smallscreen.payment_method.sendInvoiceBayarind'()
Mobile.pressBack()
Mobile.delay(1 )
Mobile.pressBack()
Mobile.startExistingApplication('net.sprintasia.ewallet')
CustomKeywords.'bayarind.control.inputPINBayarind'()
Mobile.tap(findTestObject('Object Repository/Bayarind/Android/Homepage/btnNotification') ,0)
Mobile.tap(findTestObject('Object Repository/Bayarind/Android/Notification/newNotification') ,0)
