...
Mobile.startExistingApplication('net.sprintasia.ewallet', FailureHandling.STOP_ON_FAILURE)
...
CustomKeywords.'bayarind.katalog.productGurameBakar'()
CustomKeywords.'bayarind.katalog.productPaketAyamGeprekPaketA'()
