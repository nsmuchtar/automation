...
Mobile.tap(findTestObject('Pasarind/Smallscreen/Menu Burger/categoryManagement'), 0)

Mobile.tap(findTestObject('Pasarind/Smallscreen/Category Management/btnAddCategory'), 0)
