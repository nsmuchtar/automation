...
Mobile.setText(findTestObject('Pasarind/Smallscreen/Login Page/kolomPIN'), GlobalVariable.PINLogin, 0)
...
Mobile.clearText(findTestObject('Pasarind/Smallscreen/Login Page/kolomPIN'), 0)
