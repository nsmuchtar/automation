...
Mobile.scrollToText('penyesuaian')

Mobile.tap(findTestObject('Object Repository/Pasarind Existing/Smallscreen/Menu Burger/adjustment') ,0)

Mobile.tap(findTestObject('Object Repository/Pasarind Existing/Smallscreen/Adjustment/dropDownAdjustment'), 0)

Mobile.tap(findTestObject('Object Repository/Pasarind Existing/Smallscreen/Adjustment/adjustmentVariant') ,0)

Mobile.tap(findTestObject('Object Repository/Pasarind Existing/Smallscreen/Adjustment/btnAddVariant') ,0)
