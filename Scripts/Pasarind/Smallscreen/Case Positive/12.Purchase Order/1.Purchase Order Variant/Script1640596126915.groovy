...
Mobile.tap(findTestObject('Object Repository/Pasarind Existing/Smallscreen/Menu Burger/purchaseOrder') ,0)

Mobile.tap(findTestObject('Object Repository/Pasarind Existing/Smallscreen/Purchase Order/dropDownPO'), 0)

Mobile.tap(findTestObject('Object Repository/Pasarind Existing/Smallscreen/Purchase Order/poVariant') ,0)

Mobile.tap(findTestObject('Object Repository/Pasarind Existing/Smallscreen/Purchase Order/dropDownVariant'), 0)
