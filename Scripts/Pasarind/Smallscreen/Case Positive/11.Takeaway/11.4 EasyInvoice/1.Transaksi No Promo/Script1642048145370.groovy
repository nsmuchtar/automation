...
CustomKeywords.'pasarind_smallscreen.payment_method.EasyInvoice'()

CustomKeywords.'pasarind_smallscreen.payment_method.googleMailEasyInvoice'()

CustomKeywords.'pasarind_smallscreen.payment_method.choosePaymentEasyInvoice'()
