...
Mobile.tap(findTestObject('Object Repository/Pasarind Existing/Smallscreen/Settings/Store Schedule/Halaman Store Schedule/' + GlobalVariable.inputHari3 + 'Open'), 0)
