...
Mobile.tap(findTestObject('Object Repository/Pasarind/Smallscreen/Login Page/forgotPIN'), 0)
Mobile.setText(findTestObject('Object Repository/Pasarind/Smallscreen/Forgot PIN/inputEmailHP'), GlobalVariable.loginemail, 0)
Mobile.tap(findTestObject('Object Repository/Pasarind/Smallscreen/Forgot PIN/btnSend'), 0)
if (Mobile.verifyElementExist(findTestObject('Object Repository/Pasarind/Smallscreen/Forgot PIN/iconMultipleMerchant'), 0) == true) {
	Mobile.tap(findTestObject('Object Repository/Pasarind/Smallscreen/Forgot PIN/merchant1'),0)
}else {
...
Mobile.tap(findTestObject('Object Repository/Pasarind/Smallscreen/Forgot PIN/btnDone'), 0)