...
Mobile.setText(findTestObject('Object Repository/Pasarind/Smallscreen/Product Management/kolomProductName'), GlobalVariable.namaproduct3, 0)
...
Mobile.tap(findTestObject('Object Repository/Pasarind/Smallscreen/Product Management/dropDownProductUnit'),0)

Mobile.tap(findTestObject('Object Repository/Pasarind/Smallscreen/Product Management/productUnit' + GlobalVariable.productunit2), 0)

Mobile.scrollToText('simpan')

Mobile.tap(findTestObject('Object Repository/Pasarind/Smallscreen/Product Management/switchStock') ,0)

Mobile.setText(findTestObject('Object Repository/Pasarind/Smallscreen/Product Management/android.widget.EditText - 0'), GlobalVariable.stock1, 0)

Mobile.setText(findTestObject('Object Repository/Pasarind/Smallscreen/Product Management/android.widget.EditText - 0 (1)'), GlobalVariable.stock3, 0)
